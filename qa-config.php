...
*/
	...
	define('QA_MYSQL_HOSTNAME', $db_url["host"]); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', $db_url["user"]);
	define('QA_MYSQL_PASSWORD', $db_url["pass"]);
	define('QA_MYSQL_DATABASE', substr($db_url["path"],1));
